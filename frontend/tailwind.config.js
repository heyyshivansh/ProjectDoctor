...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "pd-dossier": "0 24px 48px -12px rgba(0, 0, 0, 0.75)",
        "pd-deck": "0 24px 48px -12px rgba(0, 0, 0, 0.65), 0 0 0 1px rgba(255, 255, 255, 0.04)",
        "pd-receding": "0 12px 24px -8px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.02)",
        "pd-glow-accent": "0 0 24px -4px rgba(212, 146, 79, 0.25)",
        "pd-glow-critical": "0 0 24px -4px rgba(224, 108, 117, 0.25)",
        "pd-glow-strength": "0 0 24px -4px rgba(86, 182, 139, 0.25)",
      },
    },
  },
